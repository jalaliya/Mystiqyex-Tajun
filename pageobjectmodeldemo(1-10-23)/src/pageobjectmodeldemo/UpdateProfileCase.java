...
public class UpdateProfileCase {
	...
	public static void main(String[] args) {
		 ...
		 * UpdateProfile.phone(driver).sendKeys("234567");
		 * UpdateProfile.city(driver).sendKeys("coppell");
		 * UpdateProfile.updateProfile(driver).click();
		 */
		...
		PageFactory.initElements(driver,UpdateProfileCase.class);
		UpdateProfile.myProfile.click();
		UpdateProfile.phone.sendKeys("23435456464654656");
		UpdateProfile.city.sendKeys("coppell");
